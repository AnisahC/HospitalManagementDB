...
INSERT INTO Prescription (doctor_id, medication_id, patient_id, dosage)
VALUES
...
INSERT INTO Parent (patient_id, occupation, relationship_to_child)
VALUES
(1, 'Engineer', 'Mother'),
(2, 'Teacher', 'Father'),
(3, 'Lawyer', 'Mother');
...
INSERT INTO `Medical Records` (patient_id, doctor_id, date)
VALUES
(1, 3, '2024-12-01'),
(2, 2, '2024-12-03'),
(3, 1, '2024-12-04');
...
INSERT INTO Child (patient_id, parent_id, grade_level)
VALUES
(1, 2, 5),
(2, 1, 8),
(3, 3, 12);
...
INSERT INTO Allergies (patient_id, severity, allergen)
VALUES
(1, 'Mild', 'Peanuts'),
(2, 'Severe', 'Bee Stings'),
(3, 'Moderate', 'Pollen');
...
INSERT INTO `Lab Test` (patient_id, doctor_id, result, type)
VALUES
...
INSERT INTO `Bill` (appt_id, payment_id, due_date)
VALUES
(1, 3, '2024-12-10'),
(2, 2, '2024-12-15'),
(3, 1, '2024-12-20');
...
INSERT INTO `Diagnosis` (`patient_id`, `doctor_id`, `name`)
VALUES 
  (1, 1, 'Flu'),
  (2, 2, 'Diabetes'),
  (3, 1, 'Asthma');
